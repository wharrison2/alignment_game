...
export const STRINGS = {
  ...
  // ── Research panel ─────────────────────────────────────────────────────────
  "research.assistHint.noModel": "AI-assist needs a model to do the labor — you have none yet, so it has no effect. Train a model (even one still in post-training, before release) and it becomes available (potent, and contaminating, as capability rises).",
